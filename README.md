...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? **_enter yes/no** yes

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
**_enter the practice here** To write the code more precise and increase the speed of writing the code in a more efficient way.
